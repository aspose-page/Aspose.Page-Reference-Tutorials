---
title: How to Add Gradient – Horizontal Gradient in Java XPS
...
- **Which Java version works?** Any Java 8+ runtime  
- **Do I need a license?** A free trial works for development; a commercial license is required for production  
- **Can I change the gradient direction?** Yes – just modify the start/end points of the linear brush  
- **Is it possible to add multiple gradients?** Absolutely – repeat the path creation steps with different brushes  
