---
title: "asp page add text – Unicode in Java PostScript"
linktitle: "Add Text using Unicode String in Java PostScript"
second_title: "Aspose.Page Java API"
description: "Learn how to asp page add text in Java, set font style java, and how to add unicode text using Aspose.Page. Follow our step‑by‑step guide."
weight: 11
