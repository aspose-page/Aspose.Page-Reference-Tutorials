...
Ajouter Unicode signifie insérer des caractères représentés par des points de code au‑delà de la plage ASCII de base. Aspose.Page abstrait les détails d’encodage bas‑niveau, vous permettant de vous concentrer sur le contenu texte et son placement visuel.
...
- **Aucune dépendance externe** – Pas besoin de gérer les fichiers de polices manuellement ; l'API fonctionne avec les polices du système.  
- **API simple** – Quelques appels de méthode suffisent pour rendre du texte multilingue.
